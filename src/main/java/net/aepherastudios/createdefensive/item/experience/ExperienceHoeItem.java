...
public class ExperienceHoeItem extends HoeItem {
    public ExperienceHoeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
