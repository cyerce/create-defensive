...
public class CompoundBowItem extends BowItem {
    public CompoundBowItem(Properties pProperties) {
        super(pProperties);
    }
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        if (j > 0) {
                            abstractarrow.setBaseDamage(abstractarrow.getBaseDamage() + (double)j * 0.5 + 1.5f);
                        }
                        ...
                        if (EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FLAMING_ARROWS, pStack) > 0) {
                            ...
                            abstractarrow.setBaseDamage(abstractarrow.getBaseDamage() * 1.25f);
