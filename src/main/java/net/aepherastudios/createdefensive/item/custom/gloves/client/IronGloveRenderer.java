package net.aepherastudios.createdefensive.item.custom.gloves.client;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.aepherastudios.createdefensive.entity.client.DefensiveModelLayers;
import net.aepherastudios.createdefensive.item.custom.gloves.IronGloveItem;
import net.aepherastudios.createdefensive.item.custom.gloves.model.IronGloveModel;
