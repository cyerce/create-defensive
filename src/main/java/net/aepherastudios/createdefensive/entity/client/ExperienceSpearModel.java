...
@OnlyIn(Dist.CLIENT)
public class ExperienceSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/experience_spear.png");
    private final ModelPart root;

    public ExperienceSpearModel(ModelPart pRoot) {
