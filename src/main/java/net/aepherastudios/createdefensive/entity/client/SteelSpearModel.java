...
public class SteelSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/steel_spear.png");
    private final ModelPart root;

    public SteelSpearModel(ModelPart pRoot) {
