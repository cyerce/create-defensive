...
@OnlyIn(Dist.CLIENT)
public class AluminumSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/aluminum_spear.png");
    private final ModelPart root;

    public AluminumSpearModel(ModelPart pRoot) {
