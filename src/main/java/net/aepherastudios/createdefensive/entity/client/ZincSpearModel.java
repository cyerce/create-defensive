...
@OnlyIn(Dist.CLIENT)
public class ZincSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/zinc_spear.png");
    private final ModelPart root;

    public ZincSpearModel(ModelPart pRoot) {
