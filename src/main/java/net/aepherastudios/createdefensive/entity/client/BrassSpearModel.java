...
@OnlyIn(Dist.CLIENT)
public class BrassSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/brass_spear.png");
    private final ModelPart root;

    public BrassSpearModel(ModelPart pRoot) {
