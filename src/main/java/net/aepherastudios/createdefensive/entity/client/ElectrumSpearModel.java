...
@OnlyIn(Dist.CLIENT)
public class ElectrumSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/electrum_spear.png");
    private final ModelPart root;

    public ElectrumSpearModel(ModelPart pRoot) {
