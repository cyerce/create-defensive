...
@OnlyIn(Dist.CLIENT)
public class NetheriteSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/netherite_spear.png");
    private final ModelPart root;

    public NetheriteSpearModel(ModelPart pRoot) {
