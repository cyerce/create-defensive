...
@OnlyIn(Dist.CLIENT)
public class CopperSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/copper_spear.png");
    private final ModelPart root;

    public CopperSpearModel(ModelPart pRoot) {
