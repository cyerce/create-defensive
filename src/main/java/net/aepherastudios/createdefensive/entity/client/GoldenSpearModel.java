...
@OnlyIn(Dist.CLIENT)
public class GoldenSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/golden_spear.png");
    private final ModelPart root;

    public GoldenSpearModel(ModelPart pRoot) {
