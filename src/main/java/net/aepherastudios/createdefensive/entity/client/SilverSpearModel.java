...
@OnlyIn(Dist.CLIENT)
public class SilverSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/silver_spear.png");
    private final ModelPart root;

    public SilverSpearModel(ModelPart pRoot) {
