...
@OnlyIn(Dist.CLIENT)
public class RoseGoldSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/rose_gold_spear.png");
    private final ModelPart root;

    public RoseGoldSpearModel(ModelPart pRoot) {
