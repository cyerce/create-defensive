...
public class StoneSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/stone_spear.png");
    private final ModelPart root;

    public StoneSpearModel(ModelPart pRoot) {
