...
@OnlyIn(Dist.CLIENT)
public class RedstoneSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/redstone_spear.png");
    private final ModelPart root;

    public RedstoneSpearModel(ModelPart pRoot) {
