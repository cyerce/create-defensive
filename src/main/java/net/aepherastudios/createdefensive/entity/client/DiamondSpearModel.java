...
public class DiamondSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/diamond_spear.png");
    private final ModelPart root;

    public DiamondSpearModel(ModelPart pRoot) {
