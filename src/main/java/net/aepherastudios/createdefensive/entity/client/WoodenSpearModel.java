...
@OnlyIn(Dist.CLIENT)
public class WoodenSpearModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CreateDefensive.MOD_ID, "textures/entity/projectiles/wooden_spear.png");
    private final ModelPart root;

    public WoodenSpearModel(ModelPart pRoot) {
