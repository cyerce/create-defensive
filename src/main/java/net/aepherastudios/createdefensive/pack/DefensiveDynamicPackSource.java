...
public record DefensiveDynamicPackSource(String packId, PackType packType, Pack.Position packPosition, PackResources packResources) implements RepositorySource {
    @Override
